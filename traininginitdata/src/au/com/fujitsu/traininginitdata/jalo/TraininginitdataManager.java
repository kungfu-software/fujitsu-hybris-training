 ...
 *  
 */
package au.com.fujitsu.traininginitdata.jalo;
...
import au.com.fujitsu.traininginitdata.constants.TraininginitdataConstants;



/**
 * This is the extension manager of the Traininginitdata extension.
 */
public class TraininginitdataManager extends GeneratedTraininginitdataManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TraininginitdataManager.class.getName());
	 ...
	 */
	public static TraininginitdataManager getInstance()
	{
		return (TraininginitdataManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TraininginitdataConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TraininginitdataManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TraininginitdataManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TraininginitdataManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TraininginitdataManager called, current tenant: " + getTenant().getTenantID());
		}
	}
